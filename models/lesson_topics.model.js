...
const lessonTopicSchema = new mongoose.Schema(
    {
        lesson_id: {
            type: Number,
        },
...
const LessonTopic = mongoose.model('LessonTopic', lessonTopicSchema);

module.exports = { LessonTopic, defaultLessonTopics };
