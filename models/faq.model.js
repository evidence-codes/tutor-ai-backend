...
const defaultFAQs = [
    ...
    },
    {
        ...
        faq_body:
            ...
            '- Face-to-face interactive lessons with AI tutor\n' +
    ...
    },
    {
        ...
        faq_body:
            'Yes, the app offers interactive conversations with AI tutor to improve your speaking and listening skills. There are also dictation exercises to help you enhance your listening accuracy.',
        faq_type: 'Features',
    },
    {
        faq_id: 8,
    ...
    },
    {
        ...
        faq_body:
            'We occasionally run discounts and promotions on our subscription plans. Keep an eye out for special offers, seasonal discounts, or promotional campaigns to get the best value for your subscription.',
    ...
    },
    {
        ...
        faq_body:
            'If you encounter technical issues, we recommend trying the following steps:\n- Ensure that you have the latest version of the app installed.\n- Restart your device and relaunch the app.\n- Check your internet connection to ensure it is stable.\n- Uninstall and reinstall the app. If the issue persists, please contact our customer support for further assistance.',
        faq_type: 'Troubleshooting',
    },
    {
        faq_id: 26,
    ...
    },
    {
        ...
        faq_body:
            'If you\'re having trouble logging into your account, please follow these steps:\n- Double-check your username and password for accuracy.\n- Ensure that you have an active internet connection.\n- If you\'ve forgotten your password, use the "Forgot password" option on the login screen to reset it.\n- If the problem persists, contact our customer support and provide them with relevant details for further assistance.',
        faq_type: 'Troubleshooting',
    },
    {
        faq_id: 28,
        ...
        faq_body:
            "To improve the app's performance, try the following tips:\n- Close any unnecessary apps running in the background.\n- Ensure that your device has sufficient storage space available.\n- Restart your device to clear temporary files and processes.\n- Update the app to the latest version.\n- If the issue persists, contact our customer support for additional troubleshooting steps.",
        faq_type: 'Troubleshooting',
    },
    {
        faq_id: 29,
        ...
        faq_body:
            "If you're not receiving app notifications, please check the following:\n- Ensure that you have enabled notifications for the app in your device settings.\n- Check the app's notification settings to ensure they are properly configured.\n- Restart your device to refresh the notification system.\n- If the problem persists, please reach out to our customer support for further assistance.",
        faq_type: 'Troubleshooting',
    },
    {
        faq_id: 30,
        ...
        faq_body:
            "If certain features or content are not functioning correctly, try these steps:\n- Update the app to the latest version available.\n- Restart your device and relaunch the app.\n- Clear the app's cache or data (settings may vary based on your device).\n- Check for any available app-specific updates or patches.\n- If the issue persists, contact our customer support and provide them with detailed information about the problem.",
        faq_type: 'Troubleshooting',
    },
    {
        faq_id: 31,
    ...
    },
    {
        ...
        faq_body:
            "If you encounter errors or error messages, the app might provide some information about the issue. Try the following general steps:\n- Note down the error message or code displayed.\n- Check the app's documentation or help section to see if there's any information about the specific error.\n- If no resolution is provided, contact our customer support and provide them with the error details for further assistance.",
        faq_type: 'Troubleshooting',
    },
    {
        faq_id: 33,
        ...
        faq_body:
            "To improve connectivity issues, try these steps:\n- Check your internet connection and make sure it is stable.\n- Move closer to your Wi-Fi router or switch to a more reliable network.\n- Restart your router or modem to refresh the connection.\n- Disable and re-enable your device's Wi-Fi or mobile data.\n- If the issue persists, contact your internet service provider (ISP) or our customer support for further assistance.",
        faq_type: 'Troubleshooting',
    },
    {
        faq_id: 34,
        ...
        faq_body:
            "Unfortunately, if you've accidentally deleted your data or progress in the app, it might not be recoverable. We recommend regularly backing up your data to prevent such issues in the future.",
        faq_type: 'Troubleshooting',
    },
    {
        faq_id: 35,
        ...
        faq_body:
            "If the app is not recognizing your microphone or camera, follow these steps:\n- Check your device settings to ensure that the microphone and camera permissions are enabled for the app.\n- Restart the app and try again.\n- If the problem persists, ensure that your device's microphone and camera are functioning properly by testing them with other apps.\n- If they work fine elsewhere, contact our customer support for further assistance.",
        faq_type: 'Troubleshooting',
    },
    {
        faq_id: 36,
        ...
        faq_body:
            'If you have a question or issue that is not addressed in the FAQ, you can contact our customer support team for further assistance. Reach out to us via email, phone, or live chat, and our team will be happy to help you.',
        faq_type: 'Troubleshooting',
    },
];
...
module.exports = { FAQ, defaultFAQs };
